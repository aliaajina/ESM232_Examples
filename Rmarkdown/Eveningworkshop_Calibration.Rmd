...
# with visualization
# changing it to a log axis so we can further see the data
...
# first sum by month 
# summing by water year instead of calendar year
...
# use different low flow months, anywhere between 7-9, July, August, September
...
# subset for split sample calibration - only on the years before 1975, arbitrary split of pre and post calibration
...
# focusing specifically on August streamflow
 ...
 #Plot the column that's associated with my best simulation
