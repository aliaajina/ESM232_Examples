...
# initial conditions 0- have to have 2, have to specify which is predator and which is prey
...
# set parameters
# alpha is their interaction - how often do a prey and predator meet and does the predator succesfully get the prey
pars = c(rprey=0.5, alpha=0.3, eff=0.2,pmort=0.2, K=100)

# run the model
# run ode the same way
...
# plot 1 - how are our predator and prey interacting - here we can see the cyclical behavious
...
# graph both populations over time - cyclic thing is occuring but it is converging to a sort of stable cycling - it just hasn't gotten there yet
...
# time dividied by 10 and rounded it so we donn't have too many colors
# using color to show....
...
R here is just the intrinsic growth rates
K is carrying capacity
She used K1 and K2 which implies the carrying capacity for SP 1 is diff than SP 2
We may just have 1 K
